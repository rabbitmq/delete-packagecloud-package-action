...
COPY --from=builder /project/target/delete-packagecloud-package-action.jar /app
RUN set -eux; \
    java -jar /app/delete-packagecloud-package-action.jar test
...
ENTRYPOINT ["java", "-jar", "/app/delete-packagecloud-package-action.jar"]
